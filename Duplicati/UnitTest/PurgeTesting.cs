...
{
    public class LogForwarder : Library.Logging.ILog
    {
    ...
    public class PurgeTesting : BasicSetupHelper
    {
        ...
        {
            using (Library.Logging.Log.StartScope())
            {
                Library.Logging.Log.CurrentLog = new LogForwarder();
                Library.Logging.Log.LogLevel = LogMessageType.Information;
